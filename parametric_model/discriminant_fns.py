...
def euclidean(x, mu_i, variance, prior_prob, pp_equal = True):
    '''
...
def mahalanobis(x, mu_i, cov_matrix_inv, prior_prob, pp_equal = True):
    '''
...
def quadratic(x, mu_i, cov_mat_i, prior_prob, pp_equal = True):
